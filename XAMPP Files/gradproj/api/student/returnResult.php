...
$subjects = $pdo->prepare( "SELECT subjects.subjectname ,result.result FROM result JOIN subjects ON result.subjectid = subjects.id WHERE result.studentid = '$studentid'");
