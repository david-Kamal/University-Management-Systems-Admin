...
$studentSubject = $pdo->prepare( "SELECT subjects.subjectname ,subjects.date FROM studentsubject JOIN subjects ON studentsubject.subjectid = subjects.id WHERE studentsubject.studentid = '$studentId'");
