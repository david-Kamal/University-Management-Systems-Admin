...
$subjects = $pdo->prepare( "SELECT examschedule.* FROM examschedule JOIN studentsubject ON examschedule.subjectid = studentsubject.subjectid WHERE studentsubject.studentid = '$studentid' ");
